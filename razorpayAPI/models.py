...
class Order(models.Model):
    ...
    razorpay_order_id = models.CharField(max_length=100, default="", null=True, blank=True)
    razorpay_payment_id = models.CharField(max_length=100, default="", null=True, blank=True)
    ...
    show_amount_in_bookings = models.BooleanField(default=False)
